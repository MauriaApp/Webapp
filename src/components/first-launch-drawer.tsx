...
import { CircleAlert, Hand, MessageCircleQuestion, PanelsTopLeft, Shredder } from "lucide-react"
import {
  Drawer,
  DrawerContent,
  DrawerHeader,
      ...
      <DrawerContent className="p-0 max-h-[85vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 py-4 touch-pan-y [-webkit-overflow-scrolling:touch]">
          <Alert className="mb-4">
            ...
            <AlertDescription>
              On a remarqué que c'était ta première fois sur l'application.
              On te propose de t'expliquer comment ça marche et comment t'y retrouver.
            </AlertDescription>
          </Alert>
          ...
          <Alert variant="destructive" className="mb-4">
            ...
            <AlertDescription>
              Mauria est un outil complémentaire à Aurion :
              il ne remplace ni le site, ni ses données.
            </AlertDescription>
          </Alert>
          ...
          <Alert className="mb-4">
            ...
            <AlertDescription>
              L'application est divisé en plusieurs onglets.
              Tu peux les retrouver en bas de l'écran.
              Il y a aussi un menu en haut à droite avec des options supplémentaires.
            </AlertDescription>
          </Alert>
          ...
          <Alert className="mb-4">
            ...
            <AlertDescription>
              L'application n'enregistre rien sur ses serveurs, tout est stocké sur ton téléphone.
              De ce fait, tu peux l'utiliser sans connexion internet !
            </AlertDescription>
          </Alert>
