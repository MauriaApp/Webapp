    ...
    (
        ...
        if (collapsible === "none") {
            return (
                <div
                    className={cn(
                        "flex h-full w-(--sidebar-width) flex-col bg-sidebar oled:bg-black text-sidebar-foreground",
                        className
                    )}
                    ref={ref}
                    {...props}
            ...
            return (
                ...
                >
                    <SheetContent
                        ...
                        data-mobile="true"
                        className="w-(--sidebar-width) bg-sidebar oled:bg-black p-0 text-sidebar-foreground [&>button]:hidden"
                        style={
                            {
        ...
        return (
            ...
            >
                ...
                >
                    <div
                        data-sidebar="sidebar"
                        className="flex h-full w-full flex-col bg-sidebar oled:bg-black group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm"
                    >
                        {children}
                    </div>
                </div>
